	...
	<form method="post" action="#" id="js_activity_feed_form" enctype="multipart/form-data">
		...
		<div class="activity_feed_form_holder">		
			...
			<div class="global_attachment_holder_section" id="global_attachment_status" style="display:block;">
				...
				<textarea class = "pageFeedTextarea_786" {if isset($aPage)} id="pageFeedTextarea" {else} {if isset($aEvent)} id="eventFeedTextarea" {else} {if isset($bOwnProfile) && $bOwnProfile == false}id="profileFeedTextarea" {/if}{/if}{/if} cols="60" rows="8" maxlength="177" name="val[user_status]" placeholder="{if isset($aFeedCallback.module) || defined('PHPFOX_IS_USER_PROFILE')}{phrase var='feed.write_something'}{else}{phrase var='feed.what_s_on_your_mind'}{/if}"></textarea>
			  <br>
			  <!-- <font size="1" id = "char_limit_786">(Maximum characters: 177)</font> -->
			  <div style = "font-size:10px" class = "char_limit_786">(Maximum characters: 177)</div>
			</div>
