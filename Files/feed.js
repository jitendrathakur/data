...
$Behavior.textarea = function()
{	
	//var text_max = 177;
	$("body .pageFeedTextarea_786").keyup(function(){
		//alert("aa"+ (177 - $(this).val().length));
	  	$(".char_limit_786").text("( Characters left: " + (177 - $(this).val().length) + " )");
	  		
	});
}

$Behavior.copy_link_786 = function()
{	
	$("#copy_link_786").click(function(){
		//alert("rt");
	        $("#msg_url_clipboard").toggle();
	    });
}